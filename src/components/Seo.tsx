...
const defaultMeta = {
  ...
  siteName: 'FINDROM.IO',
  description:
    'Web portfolio of Romeo Angeles Jr whos a Front End Engineer specializing in web and mobile development by using modern framworks.',
  /** Without additional '/' on the end, e.g. https://theodorusclarence.com */
  url: 'https://findrom.vercel.app/',
  type: 'website',
  robots: 'follow, index',
  /**
